...
class _PancardScreenState extends State<PancardScreen> {
  ...
  void initState() {
    super.initState();
    //Api Call
    Provider.of<DataProvider>(context, listen: false).getLeadPAN(
                                        ...
                                        if (text.length == 10) {
                                          try {
                                            ...
                                            await Provider.of<DataProvider>(context,
                                                ...
                                                _panNumberCl.text);
                                            if (productProvider
                                                .getLeadValidPanCardData?.statusCode != 401) {
                                              ...
                                              Navigator.pushAndRemoveUntil<dynamic>(
                                                ...
                                                MaterialPageRoute<dynamic>(
                                                  builder: (BuildContext context) =>
                                                      LoginScreen(activityId: 0,subActivityId: 0),
                                                ),
                                                    (route) =>
                                ...
                                if (LeadPANData.panCard == null) {
                                  if (_panNumberCl.text.isEmpty) {
                                    ...
                                    PostLeadPanRequestModel(
                                      ...
                                      userId: SharedPref()
                                          .getString(
                                          SharedPref().LOGIN_MOBILE_NUMBER)
                                          .then((value) {
                                        value;
                                      }).toString(),
                                      activityId: 2,
