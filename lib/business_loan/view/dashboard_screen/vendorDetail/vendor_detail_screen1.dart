...
import 'package:scale_up_module/business_loan/view/dashboard_screen/model/CustomerTransactionListRequestModel.dart';
import 'package:scale_up_module/business_loan/view/dashboard_screen/my_account/model/CustomerOrderSummaryResModel.dart';
import 'package:scale_up_module/business_loan/view/dashboard_screen/my_account/model/CustomerTransactionListRespModel.dart';
import 'package:scale_up_module/business_loan/view/dashboard_screen/vendorDetail/model/TransactionList.dart';
...
class TabA extends StatefulWidget {
  ...
  late BusinessDataProvider productProvider;
...
class _TabAState extends State<TabA> with SingleTickerProviderStateMixin {
  ...
  Future<void> _showDialog(BuildContext context, BusinessDataProvider productProvider,
  ...
  Widget _dialogListView(BuildContext context, BusinessDataProvider productProvider,
      List<TransactionList> transactionList) {
  ...
  Future<void> getTransactionBreakup(BuildContext context,
      BusinessDataProvider productProvider, String invoiceId) async {
    final prefsUtil = await SharedPref.getInstance();
