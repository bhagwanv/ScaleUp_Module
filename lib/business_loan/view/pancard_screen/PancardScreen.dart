...
import 'package:scale_up_module/business_loan/view/pancard_screen/model/PostLeadPANRequestModel.dart';
...
class _PancardScreenState extends State<PancardScreen> {
  ...
  Future<void> leadPANApi(BuildContext context) async {
    ...
    Provider.of<BusinessDataProvider>(context, listen: false).getLeadPAN(userId!,productCode!);
  }
  ...
  Future<void> getFathersNameByValidPanCard(BuildContext context,
      String pancardNumber, BusinessDataProvider productProvider) async {
    Utils.onLoading(context, "");
    await Provider.of<BusinessDataProvider>(context, listen: false)
  ...
  Future<void> postLeadPAN(BuildContext context, BusinessDataProvider productProvider,
