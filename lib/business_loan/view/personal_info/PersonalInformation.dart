...
import 'package:scale_up_module/business_loan/view/personal_info/EmailOtpScreen.dart';
...
class _PersonalInformationState extends State<PersonalInformation> {
  ...
  Widget buildStateField(BusinessDataProvider productProvider) {
    if (personalDetailsResponce != null) {
  ...
  Widget buildCityField(BusinessDataProvider productProvider) {
    if (personalDetailsResponce!.permanentCity != null) {
  ...
  Future<void> getPersonalDetailAndStateApi(BuildContext context) async {
    ...
    Provider.of<BusinessDataProvider>(context, listen: false).getAllState();
  }

  Widget permanentAddressField(BusinessDataProvider productProvider) {
    return Column(
      children: [
         Align(
  ...
  Widget basicDetailsFields(BusinessDataProvider productProvider) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        TextField(
  ...
  Widget currentAddressFields(BusinessDataProvider productProvider) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
         Align(
  ...
  Future<void> getKarzaElectricityAuthentication(BuildContext context,
      BusinessDataProvider productProvider, String districtName) async {
    final prefsUtil = await SharedPref.getInstance();
  ...
  Widget digitalBillFields(BusinessDataProvider productProvider) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Column(
