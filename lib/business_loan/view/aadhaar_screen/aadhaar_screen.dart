...
class _AadhaarScreenState extends State<AadhaarScreen> {
  ...
  BusinessDataProvider productProvider = BusinessDataProvider();
  ...
  void _onFontImageSelected(File imageFile) async {
    ...
    await Provider.of<BusinessDataProvider>(context, listen: false).PostFrontAadhaarSingleFileData(imageFile, true, "", "");
  ...
  void generateAadhaarOTPAPI(
    ...
    await Provider.of<BusinessDataProvider>(context, listen: false).leadAadharGenerateOTP(request);
  ...
  Future<void> getAadhaarData(BuildContext context) async {
    ...
    Provider.of<BusinessDataProvider>(context, listen: false).getLeadAadhar(userId!,productCode!);
  }
}
