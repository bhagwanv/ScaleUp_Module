...
import 'package:scale_up_module/business_loan/view/bank_details_screen/model/CreditDayAmountCals.dart';
import 'package:scale_up_module/business_loan/view/bank_details_screen/model/CreditDayWiseAmounts.dart';
import 'package:scale_up_module/business_loan/view/checkoutView/CongratulationScreen.dart';
...
class _PaymentConfirmationState extends State<PaymentConfirmation> {
  ...
  void payemtOrderPost(BuildContext context, BusinessDataProvider productProvider, TransactionDetailModel transactionDetailModel)async {
    ...
    await Provider.of<BusinessDataProvider>(context, listen: false).PostOrderPlacement(payemtOrderPostRequestModel);
    Navigator.of(context, rootNavigator: true).pop();
