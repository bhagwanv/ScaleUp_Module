...
class _CreditLineApprovedState extends State<CreditLineApproved> {
  ...
  void callDisbursementApi(BuildContext context) async {
    ...
    Provider.of<BusinessDataProvider>(context, listen: false).getDisbursementProposal(leadId!);
  }
  ...
  void callApi(BuildContext context) async {
    ...
    await Provider.of<BusinessDataProvider>(context, listen: false).GetLeadOffer(leadId!, prefsUtil.getInt(COMPANY_ID)!);
    Navigator.of(context, rootNavigator: true).pop();
