...
import 'package:scale_up_module/business_loan/view/profile_screen/model/OfferPersonNameResponceModel.dart';
import 'package:scale_up_module/business_loan/view/profile_screen/model/OfferResponceModel.dart';
import 'package:scale_up_module/business_loan/view/pwa/Pwascreen.dart';
...
class _DisbursementScreenState extends State<ShowOffersScreen> {
  ...
  Future<void> getCheckStatus(BuildContext context, BusinessDataProvider productProvider,) async {
  ...
  Widget SetOfferWidget(BusinessDataProvider productProvider) {
  ...
  Widget SetCutomerOfferWidget(BusinessDataProvider productProvider) {
  ...
  Future<void> acceptOffer(
    ...
    final int? leadId = prefsUtil.getInt(LEADE_ID);
    Utils.onLoading(context, "");
    Provider.of<BusinessDataProvider>(context, listen: false).getAcceptOffer(leadId!);
    Navigator.of(context, rootNavigator: true).pop();
