...
class _MsmeRegistrationScreenState extends State<MsmeRegistrationScreen> {
  ...
  Widget selectBusinessTypeWidget(BusinessDataProvider productProvider) {
  ...
  Future<void> getLeadMSME(BuildContext context) async {
    ...
    Provider.of<BusinessDataProvider>(context, listen: false).getLeadMSME(userId!,productCode!);

  }

  Future<void> submitpostLeadMSMEApi(BuildContext context, BusinessDataProvider productProvider,) async {
    if (_msmeRegNumCl.text.trim().isEmpty) {
      ...
      await Provider.of<BusinessDataProvider>(context, listen: false).postLeadMSME(postLeadMsmeReqModel);
      Navigator.of(context, rootNavigator: true).pop();
  ...
  Future<void> uoploadPDF(BuildContext context, BusinessDataProvider productProvider) async {
